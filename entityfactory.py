...
class EntityFactory:
    ...
    def get_entity(entity_name: str):
        #define o tamanho da entidade conforme a lista de tamanhos, e eles se mantem proporcionais ao tamanho da tela
        ...
        match entity_name:
            ...
            case 'inimigo1':
                # Posiciona o inimigo1 dentro da tela, perto da borda direita em uma altura aleatoria
